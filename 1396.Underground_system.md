- Core to efficiently store/look each completed trip : use concantenated string of start and end station as the key, and map it to the total frequency and time incurred until now.
